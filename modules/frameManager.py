...
class FrameManager(object):
    ...
    class _FM(object):
        ...
        _FRAME_SIZES = {
            ...
            "player2.png": (470,470),
            "pp.png":(470,470),
            "rightGoal.png": (300, 400),
            "leftGoal.png": (300, 400),
            "powerUps.png": (190,190),
            "SoccerBall.png": (100, 100)
        ...
        _TRANSPARENCY = ["flowers-transparent.png", "SoccerBall.png", "playerF.png", "player2.png","pp.png"
                         ]

        # A list of images that require to be loaded with a color key
        _COLOR_KEY = ["flowers-color-key.png",
                      "water-lilly.png", "star.png", "kirby.png", "leftGoal.png", "rightGoal.png", "SoccerBall.png","powerUps.png"]
        ...
        def _loadImage(self, fileName, sheet=False):
            ...
            if fileName in FrameManager._FM._SCALE.keys():
                img = Vector2(*fullImage.get_size()) * \
                    FrameManager._FM._SCALE[fileName]

                fullImage = pygame.transform.scale(
                    fullImage, list(map(int, img)))
                FrameManager._FM._FRAME_SIZES[fileName] = list(map(int, Vector2(
                    *FrameManager._FM._FRAME_SIZES[fileName]) * FrameManager._FM._SCALE[fileName]))
