...
class FrameManager(object):
    ...
    class _FM(object):
        ...
        _COLOR_KEY = ["flowers-color-key.png",
                      "water-lilly.png", "star.png", "kirby.png", "leftGoal.png", "rightGoal.png", "SoccerBall.png","powerUps.png","powerUp2.png"]
         ...
         if sheet:
            ...
            for y in range(0, sheetDimensions[1], spriteSize[1]):
               ...
               for x in range(0, sheetDimensions[0], spriteSize[0]):
                  ...
                  if fileName in FrameManager._FM._SCALE:
                    frame = pygame.transform.scale(frame,list(map(int,Vector2(*spriteSize) * FrameManager._FM._SCALE[fileName])))
            ...
            if fileName in FrameManager._FM._SCALE:
                fullImage = pygame.transform.scale(fullImage, list(map(int,Vector2(*fullImage.get_size()) * FrameManager._FM._SCALE[fileName])))
