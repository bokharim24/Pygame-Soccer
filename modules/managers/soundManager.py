...
class SoundManager(object):
   ...
   class _SM(object):
      ...
      _FOLDER = {
         "long.wav"     : _MUSIC_FOLDER,
         "forGoal.wav" : _MUSIC_FOLDER,
         "goalz.mp3"     : _MUSIC_FOLDER,
         "regularPlay.wav" : _MUSIC_FOLDER,
         "loadScreen.mp3"     : _MUSIC_FOLDER,
         "crossbar.mp3": _MUSIC_FOLDER
      ...
      def playSound(self, fileName, loop=-1):
      ...
      def playMusic(self, fileName, loop=-1):
      ...
      def updateVolumePositional(self, channel, relativePosition, soundPosition, distance=300, minVolume=0.2):
         ...
         if (channel.get_busy() and channel != None):
